...
export default function FormTouristDestination({
    onSubmit,
    onCancel,
    process,
    initialValues,
    ...
    const [isFullDay, setIsFullDay] = useState(
        initialValues?.is_24_hours ?? false
    );
    ...
    const getPathFromUrl = (url) => {
        ...
        return decodeURIComponent(pathname.split("/").slice(4).join("/"));
    };
                ...
                >
                    <Row gutter={16}>
                        <Col span={24}>
                            ...
                            >
                                <Input placeholder="Masukkan Nama Destinasi Wisata..." />
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item
